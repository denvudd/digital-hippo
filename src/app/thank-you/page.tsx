...
const Page: React.FC<PageProps> = async ({ searchParams }) => {
  ...
  return (
    <main className="relative lg:min-h-full">
      <div className="hidden h-full lg:block overflow-hidden lg:absolute lg:h-full lg:w-1/2 lg:pr-4 xl:pr-12">
        <Image
          fill
          ...
          <div className="lg:col-start-2">
            ...
            {order._isPaid ? (
              ...
              <p className="mt-2 text-base text-muted-foreground">
                ...
                it. So hang tight and we&apos;ll sent you confirmation very
                soon!
              </p>
            )}
            ...
            <div className="mt-16 text-sm font-medium">
              ...
              <div className="space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-muted-foreground">
                ...
                <div className="flex items-center justify-between border-t border-gray-300 pt-6 text-gray-900">
